      ...
      <div style={{ marginBottom: 24 }}>
        <div className={styles.infoRow}>
          <div className={styles.infoItem}>
            ...
            <span className={styles.infoValue}>{player.positions || '—'}</span>
          </div>
          <div className={styles.infoItem}>
            <span className={styles.infoLabel}>Height</span>
            <span className={styles.infoValue}>{formatHeight(player.heightInches)}</span>
          </div>
          <div className={styles.infoItem}>
            <span className={styles.infoLabel}>Weight</span>
            <span className={styles.infoValue}>{player.weightLbs ? `${player.weightLbs}` : '—'}</span>
          </div>
          <div className={styles.infoItem}>
            <span className={styles.infoLabel}>Bats</span>
            <span className={styles.infoValue}>{player.bats || '—'}</span>
          </div>
          <div className={styles.infoItem}>
            <span className={styles.infoLabel}>Throws</span>
            <span className={styles.infoValue}>{player.throws || '—'}</span>
          </div>
        </div>
        ...
        <div className={styles.infoRow}>
          <div className={styles.infoItem}>
            ...
            <span className={styles.infoValue}>{player.gradYear || '—'}</span>
          </div>
          <div className={styles.infoItem}>
            <span className={styles.infoLabel}>Age</span>
            <span className={styles.infoValue}>{getAge(player.birthDate, player.gradYear)}</span>
          </div>
          <div className={styles.infoItem}>
            <span className={styles.infoLabel}>High School</span>
            <span className={styles.infoValue}>{player.highSchool || '—'}</span>
          </div>
          <div className={styles.infoItem}>
            <span className={styles.infoLabel}>Club Team</span>
            <span className={styles.infoValue}>{player.clubTeam || '—'}</span>
          </div>
        </div>

        <div className={styles.infoRow}>
          <div className={styles.infoItem}>
            <span className={styles.infoLabel}>PBR National</span>
            <span className={styles.infoValue}>{player.pbrNational ? `#${player.pbrNational}` : '—'}</span>
          </div>
          <div className={styles.infoItem}>
            <span className={styles.infoLabel}>PBR State</span>
            <span className={styles.infoValue}>{player.pbrState ? `#${player.pbrState}` : '—'}</span>
          </div>
          <div className={styles.infoItem}>
            <span className={styles.infoLabel}>PBR Position</span>
            <span className={styles.infoValue}>{player.pbrPosition ? `#${player.pbrPosition}` : '—'}</span>
          </div>
          <div className={styles.infoItem}>
            <span className={styles.infoLabel}>PG Score</span>
            <span className={styles.infoValue}>{player.pgScore || '—'}</span>
          </div>
        </div>
      </div>
