...
export function SchedulePdf({ playerName, events, selectedTabs, scope, today }: Props) {
  ...
  return (
    <Document>
      <Page size="A4" orientation="landscape" style={{ backgroundColor: '#FFFFFF', padding: 28, fontFamily: 'Helvetica', color: colors.textDark }}>
        {/* Header — Defined logo, top-left, next to the player name. */}
        ...
        {/* Next 7 days strip — drill types per day */}
        ...
        {tabs.map((tab) => {
          ...
          return (
            <View key={tab} style={{ marginBottom: 12 }}>
